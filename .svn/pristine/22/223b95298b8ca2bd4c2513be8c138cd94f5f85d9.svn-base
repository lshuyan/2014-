...
- (void)setTitleView:(UIView *)titleView
{
    ...
    _navBar.topItem.titleView = titleView;
}
...
{
    return _navBar.topItem.rightBarButtonItems[0];
}
...
- (CGRect)resizeWithOrientation:(UIInterfaceOrientation)orientation
{
    ...
    rc.size.width = UIInterfaceOrientationIsPortrait(orientation)?MIN(sizeScreen.width,sizeScreen.height):MAX(sizeScreen.width,sizeScreen.height);
