...
- (void)setState:(MJRefreshState)state
{
	...
	switch (state)
    {
        ...
        {
            _statusLabel.text = LocalizedString(MJRefreshFooterReleaseToRefresh);
        ...
        {
            _statusLabel.text = LocalizedString(MJRefreshFooterPullToRefresh);
        ...
        case MJRefreshStateRefreshing:
        {
            ...
            _statusLabel.text = LocalizedString(MJRefreshFooterRefreshing);
            _arrowImage.transform = CGAffineTransformMakeRotation(M_PI);
            [UIView animateWithDuration:MJRefreshAnimationDuration animations:^{
                UIEdgeInsets inset = _scrollView.contentInset;
