...
- (void)viewDidLoad
{
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(didSyncNotification:) name:kNotificationDidSync object:nil];
...
- (void)didSyncNotification:(NSNotification *)notification
{
    [_viewSync updateUserStatus];
