...
- (void)awakeFromNib
{
    ...
    model.shareType = ShareTypeTwitter;
    [arrItem addObject:model];
    
    model = [ModelSNSItem model];
    model.shareType = ShareTypeGooglePlus;
    [arrItem addObject:model];
    
    model = [ModelSNSItem model];
    model.shareType = ShareTypeInstagram;
    [arrItem addObject:model];
    
    model = [ModelSNSItem model];
    model.shareType = ShareTypeLinkedIn;
    [arrItem addObject:model];
    
    model = [ModelSNSItem model];
    model.shareType = ShareTypeWhatsApp;
    [arrItem addObject:model];
#endif
