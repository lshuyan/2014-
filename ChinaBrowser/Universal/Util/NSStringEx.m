...
+ (NSString *)stringWithTimeInterval:(NSTimeInterval)timeInterval {
    ...
    if (dis>=2*30*86400) {
        ...
        result = [NSString stringWithFormat:@"%02d-%02d %02d:%02d", (int)dateComponents.month, (int)dateComponents.day, (int)dateComponents.hour, (int)dateComponents.minute];
    }
        ...
        // 超过一周
        result = [NSString stringWithFormat:@"%d%@", (int)dis/(7*86400), LocalizedString(@"zhouqian")];
    }
    else if (dis>=2*86400) {
        // 超过2天
        result = [NSString stringWithFormat:@"%d%@", (int)dis/86400, LocalizedString(@"tianqian")];
    }
    else if (dis>=1*86400) {
        // 超过1天
        result = @"昨天";
        ...
        result = [NSString stringWithFormat:@"%d%@", (int)dis/3600, LocalizedString(@"xiaoshiqian")];
    }
    else if (dis>=60) {
        result = [NSString stringWithFormat:@"%d%@", (int)dis/60, LocalizedString(@"fenzhongqian")];
    }
    else if (dis>3) {
        result = [NSString stringWithFormat:@"%d%@", (int)dis, LocalizedString(@"miaoqian")];
    }
    else {
        result = @"刚刚";
    }
