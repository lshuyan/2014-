...
- (void)setup
{
    _db = [[FMDatabase alloc] initWithPath:GetDBPathWithName(@"sync.sqlite")];
    [_db open];
...
- (void)createTable
{
    ...
    "sync_data_type integer default 0,"
    "pkid_server integer default 0,"
    "update_time integer default 0);";
    ...
    // 同步时间
    NSString *sql_sync_time = @"create table if not exists tab_sync_time("
    "pkid integer not null primary key autoincrement default 1,"
    "user_id integer default 0,"
    "lan text,"
